...
public class CheckerPane extends JPanel {
    ...
    private CheckerFrame parentFrame;
    ...
    public CheckerPane(CheckerFrame cf) {
        super();
        game = null;
        setBackground(bgColor);
        parentFrame = cf;
        addMouseListener(new CyberthelloPaneMouseListener());
    }

    public void setGame(CheckerGame game) {
        this.game = game;
        repaint();
    }
    ...
    public void paint(Graphics g) {
        ...
        if (game == null)
            ...
            int ellipseWidthOffsetSmall = ellipseWidthOffset / 10;
            int ellipseHeightOffsetSmall =  ellipseHeightOffset /10;
    ...
    // inner class
    public class CyberthelloPaneMouseListener extends MouseAdapter {
