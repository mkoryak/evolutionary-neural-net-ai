...
public class CheckerGameApplet extends Thread {
	...
	public CheckerGameApplet(int secondsPerPlayer, CheckerInterface blackAgent, 					   CheckerInterface whiteAgent, CheckerFrameApplet frame, String whiteName, String blackName,
		...
		currentBoard = new CheckerBoardApplet(whiteOnTop);
...
//				logger.reportMove(m, color, time);
	...
	public CheckerBoardApplet getCurrentBoard() {
		return currentBoard;
	}
